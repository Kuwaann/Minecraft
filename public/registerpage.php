            ...
            <section class="box-border">
                <div class="flex">
                    ...
                    <div class="flex-[2] flex flex-col justify-center items-center w-full border-l-[8px] border-l-gray-800 px-5">
                        <h1 class="Minecrafter text-white text-4xl text-center mb-3">Register</h1>
                        ...
                        <form class="w-full mb-5" action="../app/register_process.php" method="POST">
                            ...
                            <button type="submit" class="w-full bg-[#00be00] border-4 border-[#2fff2f] text-[#ffffff] h-12 cursor-pointer Minecrafter text-md px-6">REGISTER</button>
                        </form>
                        <p class="text-white">Already have an account? <a href="../public/loginpage.php" class="text-[#2fff2f]">Sign In</a> or <a href="../public/homepage.php" class="text-[#2fff2f]">Guest Mode</a></p></p>
                    </div>
                </div>
            </section>
        </main>
