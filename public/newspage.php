            ...
            <section class="flex flex-col justify-center items-center h-auto px-48">
                <div class="pt-36 mb-52">
                    ...
                    <div class="grid gap-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 place-items-center box-border">
                        ...
                        <div class="news-item w-full min-h-[25rem] h-[25rem] max-h-[25rem] bg-[#131313] p-5 overflow-hidden">
                            ...
                            <a href="singlenewspage.php?id_news=<?= $n['id_news'] ?>" class="bg-[#00be00] border-4 border-[#2fff2f] text-[#ffffff] h-12 cursor-pointer MinecraftSevenV2 text-sm px-6">READ MORE</a>
                        </div>
                        <?php endforeach; ?>
                    </div>
                </div>
